...
void testMCintegralMany() {
   ...
   // For each, rpeat the integral 100 times to see the variation of values.
   for (int i=0; i<5; i++) {
      ...
      for(int j=0; j<100; j++) {
          ...
          cout<<"  "<<counter<<"  ntry "<<ntry<<"  deltaA "<<deltaA<<endl;

          outfile<<"  "<<counter<<"  "<<ntry<<"  "<<deltaA<<endl;;

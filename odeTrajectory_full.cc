...
//====================================================================
void Trajectory(string outID,int everyNpoints){

  double tmax=10000.0;
  double dt=0.01;

  double v0=600.0;
  double theta=60.0*3.1415/180.0;
...
int main() {
  ...
  kconstant=0.0;
  int everyNpoints=1;
  Trajectory("K000",everyNpoints);  

  kconstant=0.005;
  Trajectory("K005",everyNpoints);

  kconstant=0.01;
  Trajectory("K01",everyNpoints);

  kconstant=0.02;
  Trajectory("K02",everyNpoints);

  kconstant=0.04;
  Trajectory("K04",everyNpoints);

  kconstant=0.08;
  Trajectory("K08",everyNpoints);

  // -- output every N points to the file.
  everyNpoints=1000;
  kconstant=0.00;
  Trajectory("K000a",everyNpoints);

  kconstant=0.005;
  Trajectory("K005a",everyNpoints);

  kconstant=0.01;
  Trajectory("K01a",everyNpoints);

  kconstant=0.02;
  Trajectory("K02a",everyNpoints);

  kconstant=0.04;
  Trajectory("K04a",everyNpoints);

  kconstant=0.08;
  Trajectory("K08a",everyNpoints);
